...
<head>
  ...
  <title>Vehicle Owner · My Vehicles · Bull Auto</title>
...
<div class="ba-page-title"><div><h1>My Vehicles</h1></div>
<button class="btn btn-ba-primary"><i class="bi bi-plus-lg me-1"></i>Add vehicle</button></div>
<div class="row g-3">
        <div class="col-md-6"><div class="ba-card h-100">
          <div class="d-flex justify-content-between"><h4>BMW 320i 2019</h4><span class="pill info">Active</span></div>
          <p class="text-muted">Plate: DE-AB 1234 · 42,100 km</p>
          <button class="btn btn-ba-outline btn-sm">View details</button>
        </div></div>
        <div class="col-md-6"><div class="ba-card h-100">
          <div class="d-flex justify-content-between"><h4>Renault Clio 2018</h4><span class="pill info">Active</span></div>
          <p class="text-muted">Plate: DE-AB 5678 · 58,210 km</p>
          <button class="btn btn-ba-outline btn-sm">View details</button>
        </div></div></div></div>
  </div>
</div>
