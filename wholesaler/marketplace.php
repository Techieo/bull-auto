...
<head>
  ...
  <title>Wholesaler · Marketplace · Bull Auto</title>
...
<div class="ba-page-title"><div><h1>Marketplace</h1><p>AI-ranked suppliers and parts.</p></div>
<input class="form-control" placeholder="Search parts…" style="max-width:300px"></div>
<div class="row g-3"><div class="col-sm-6 col-lg-4"><div class="ba-product">
          <div class="img"><i class="bi bi-disc"></i></div>
          <div class="body">
            <h5>Bosch Brake Pads</h5><div class="text-muted small">Bosch GmbH</div>
          ...
          <div class="body">
            <h5>NGK Iridium Plug</h5><div class="text-muted small">NGK Co.</div>
          ...
          <div class="body">
            <h5>Mann Oil Filter</h5><div class="text-muted small">Mann-Filter SA</div>
          ...
          <div class="body">
            <h5>Sumitomo Tire 205</h5><div class="text-muted small">Sumitomo</div>
          ...
          <div class="body">
            <h5>Denso Alternator</h5><div class="text-muted small">Denso</div>
          ...
          <div class="body">
            <h5>Hella LED Headlight</h5><div class="text-muted small">Hella</div>
